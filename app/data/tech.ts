...
export const techRegistry: Record<string, Tech> = {
  ...
  gin: { name: "Gin (Go)", Icon: SiGo, color: "#00ADD8", category: "framework" },
  fiber: { name: "Fiber (Go)", Icon: SiGo, color: "#00ADD8", category: "framework" },
  echo: { name: "Echo (Go)", Icon: SiGo, color: "#00ADD8", category: "framework" },
  nuxt: { name: "Nuxt", Icon: SiNuxtdotjs, color: "#00DC82", category: "framework" },
  solid: { name: "SolidJS", Icon: SiSolid, color: "#2C4F7C", category: "framework" },
  fastify: { name: "Fastify", Icon: SiFastify, category: "framework" },
